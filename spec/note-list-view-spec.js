describe('NoteListView', () => {
  describe('.html', () => {
    it('returns a string of HTML that represents the note list model', () => {
      ...
      newNoteList.createNote("This is test note number 1. Only the first 20 characters should be shown.")
      newNoteList.createNote("This is test note number 2. Only the first 20 characters should be shown.")
